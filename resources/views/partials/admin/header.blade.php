...
<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        @if (setting('general.admin_theme', 'skin-green-light') == 'skin-green-light')
            ...
            <span class="logo-lg"><img src="{{ asset('public/img/akaunting-logo-white.png') }}" class="logo-image-lg" width="25" alt="Akaunting Logo"> <b>MSCFO</b></span>
        @else
            <!-- mini logo for sidebar mini 50x50 pixels -->
            ...
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="{{ asset('public/img/akaunting-logo-green.png') }}" class="logo-image-lg" width="25" alt="Akaunting Logo"> <b>MSCFO</b></span>
        @endif
    </a>
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <!-- Updates: style can be found in dropdown.less -->
                <li class="hidden-xs">
                    <a href="{{ url('https://baidu.com/docs') }}" target="_blank" title="{{ trans('general.help') }}">
